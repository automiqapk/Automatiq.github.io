...
- Repositório: `https://github.com/automiqapk/Automatiq.github.io`;
- Endereço previsto do site: `https://automiqapk.github.io/Automatiq.github.io/`;
- LinkedIn, Instagram, telefone e localização não são apresentados.
...
- [x] Configurar o endereço de correio eletrónico;
- [x] Adicionar a ligação pública para o GitHub;
- [x] Atualizar URL canónica, Open Graph, sitemap e robots;
